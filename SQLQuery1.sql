...
SELECT *
FROM PortofolioProject..covid_deaths
...
--SELECT *
--FROM PortofolioProject..covid_vaccinations
--Order by 3,4
...
-- Missing data appear with the method commented out below
...
FROM PortofolioProject..covid_deaths dea
Join PortofolioProject..covid_vaccinations vac
